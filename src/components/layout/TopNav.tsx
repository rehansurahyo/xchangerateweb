    ...
    return (
        <nav className="fixed top-0 left-0 right-0 h-16 z-50 px-6 border-b border-white/5 bg-[#050A12]/80 backdrop-blur-xl flex items-center justify-between">
            ...
            <Link href="/dashboard" className="flex items-center group">
                <div className="relative w-28 h-7 group-hover:scale-105 transition-transform duration-300">
                    <Image
                        src="/assets/logo.png"
            ...
            <div className="relative">
                ...
                >
                    ...
                    <div className="text-left hidden sm:block">
                        <p className="text-[10px] font-black text-white leading-none uppercase tracking-tighter mb-0.5">{userName}</p>
                        ...
                        <div className="absolute top-full right-0 mt-3 w-56 glass-card p-2 border border-white/10 shadow-2xl animate-in fade-in zoom-in-95 duration-200">
                            ...
                            <div className="mt-2 pt-2 border-t border-white/5">
                                <button
                                    ...
                                    className="w-full flex items-center space-x-3 px-3 py-2.5 rounded-xl text-xs font-bold text-red-400/80 hover:text-red-400 hover:bg-red-400/5 transition-all group"
                                >
